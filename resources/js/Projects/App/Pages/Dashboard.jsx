                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        ...
                        <p className="p-4 pt-4 font-thin">
                            ...
                            <br /><br />
                            Another thing I should mention is that I have change the Laravel routing system to suit my needs, I feel that in an app, there should be multiple apps working under one project, these app can be used in other projects so its in my interest to make it so the app can be copied easier from one project to another with minimal set up.
                        </p>
                    </div>
                </div>
            </div>
